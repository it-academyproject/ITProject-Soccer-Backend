package com.itacademy.soccer.weather;

import com.itacademy.soccer.dto.weather.*;
...
public class WeatherService extends MappingJackson2HttpMessageConverter {
    ...
    //get api key: https://home.openweathermap.org/api_keys after registration
    private String apiKey = "16e0f8a443a05ec09bfface311a1bfd8";

    //a que periodo en el futuro quieres que te saque el tiempo, periodos de 3 horas hasta 5 dias




    public Example getWeatherForFive(String city, int timePeriods) throws ParseException, JSONException {
       
    	String websiteResponse = "http://api.openweathermap.org/data/2.5/forecast?q="+city+"&mode=json&cnt="+timePeriods+"&appid="+apiKey+"&units=metric";
...
String websiteResponse = "http://api.openweathermap.org/data/2.5/weather?q="+city+"&mode=json&appid="+apiKey+"&units=metric";
        ...
        pressure = main.getInt("pressure");
        humidity = main.getInt("humidity");
        temp_min= (int) main.getDouble("temp_min");
        temp_max= (int) main.getDouble("temp_max");
